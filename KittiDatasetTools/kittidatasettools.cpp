#include "kittidatasettools.h"

KittiDatasetParser::KittiDatasetParser(std::string path_to_oxts_folder,EKF_INS::EKF &ekf, QObject *parent)
    : QObject(parent), ekf_(&ekf), path_to_oxts_folder_(path_to_oxts_folder), is_playing_(false),
      is_data_ready_(false) {
    QObject *qmlObejct = this->findChild<QObject*>("");
}
...
void KittiDatasetParser::loadButtonClicked() {}

void KittiDatasetParser::startButtonClicked() {}
